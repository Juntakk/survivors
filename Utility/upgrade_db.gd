...
const UPGRADES = {
	...
	"fireshield1": {
		"icon": WEAPON_PATH + "fireshield.png",
		"displayname": "Fire Shield",
		"details": "A Fire Shield that damages nearby enemies",
		"level": "Level: 1",
		"prerequisite": [],
		"type": "upgrade"
	},
	"fireshield2": {
		"icon": WEAPON_PATH + "fireshield.png",
		"displayname": "Fire Shield",
		"details": "Gains 20% more area",
		"level": "Level: 2",
		"prerequisite": ["fireshield1"],
		"type": "upgrade"
	},
	"fireshield3": {
		"icon": WEAPON_PATH + "fireshield.png",
